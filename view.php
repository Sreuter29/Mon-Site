...
<head>
  ...
  <script src="js/jquery.lineProgressbar.js" defer></script>
  ...
  <script src="js/apropos.js" type="text/javascript" defer></script>
  <script src="js/competences.js" type="text/javascript" defer></script>
  <script src="js/parcours.js" type="text/javascript" defer></script>
  <script src="js/realisations.js" type="text/javascript" defer></script>
...
<body>
  ...
  <header>
    <nav>
      ...
      <div class="nav">
        <ul class="menu">
          <li><a href="#a-propos" class="notbigger" data-anim="6">A Propos</a></li>
          <li><a href="#competences" class="notbigger" data-anim="7">Compétences</a></li>
          <li><a href="#parcours" class="notbigger" data-anim="8">Parcours</a></li>
          <li><a href="#realisations" class="notbigger" data-anim="9">Réalisations</a></li>
          <li><a href="#contact" class="notbigger" data-anim="10">Contact</a></li>
        </ul>
      </div>
    </nav>
  </header>
  <main>
          ...
          <div class="slide" id="slide2">
            <div class="sliders">
              ...
              <div class="aside">
                ...
                <ul class="fa-ul">
                  <li><span class="fa-li"><i class="fas fa-map-pin"></i></span>jouer avec mes chats</li>
                  <li><span class="fa-li"><i class="fas fa-map-pin"></i></span>faire des randonnées en roller, parfois tomber, me relever</li>
                  <li><span class="fa-li"><i class="fas fa-map-pin"></i></span>faire des virées à vélo avec mes amis</li>
    ...
    <section id="realisations" data-anim="9">
      ...
      <div class="portefolio">
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['php']) || isset($_POST['sql']) || isset($_POST['all'])) {?> <?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['php']) || isset($_POST['css']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['php']) || isset($_POST['jquery']) || isset($_POST['css']) || isset($_POST['all']))
        {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['sql']) || isset($_POST['php']) || isset($_POST['css']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['sql']) || isset($_POST['php']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['php']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['js']) || isset($_POST['css']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['css']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['css']) || isset($_POST['jquery']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['css']) || isset($_POST['js']) || isset($_POST['jquery']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['css']) || isset($_POST['js']) || isset($_POST['all'])) {?><?='
        ...
        <?php if(((empty($_POST)) || isset($_POST['button'])) || isset($_POST['css']) || isset($_POST['jquery']) || isset($_POST['js']) || isset($_POST['all'])) {?><?='
